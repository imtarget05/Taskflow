...
- Test status: server 364/364 pass (39 suites), client 29/29 pass. Build + typecheck + lint sạch (19 warnings, 0 errors). Localhost boot verified: endpoints sống, không 5xx.
